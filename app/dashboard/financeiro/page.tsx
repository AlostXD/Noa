    ...
    <>
      ...
      <div className="bg-[#f1f5ff] flex flex-col w-full min-h-screen 2xl:px-[198px]">
        <div className="flex-1 p-4 flex flex-col">
          ...
          <div className="mt-6 text-lg font-semibold">Seus produtos</div>
          ...
          <div className="flex flex-col gap-4 lg:gap-8 font-normal">
            ...
            <div className="mt-6 text-lg font-semibold">Faturas</div>

            <div className="mt-2 flex-1 bg-white rounded-2xl p-4 border border-gray-300">
              {pagamento.map((pagamento) => (
                <div
                  key={pagamento.id}
                  className="flex item-center justify-between p-4 border-b border-gray-200"
                >
                  <div>
